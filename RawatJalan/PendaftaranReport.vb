...
Public Class PendaftaranReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RawatJalan.PendaftaranReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPendaftaranReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PendaftaranReport = New PendaftaranReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
